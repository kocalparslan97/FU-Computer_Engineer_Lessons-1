...
; Gecikme alt program?nda  4 MHz kristal icin her bir komut 1mikrosn
; ?ç içe  yaklas?k 1sn gecikme olur. 
; NOP bir cycle bekleme yapaca?? unutulmamal?
; Her bir sn de portB nin 0. pini 1 ve 0 yap?lmakta
...
DD
	MOVLW	0x00		    ; Varsay?lan olarak 0 '? haz?rda beklet
	BTFSS	PORTB,0		    ; portb nin ilk biti 1 ise varsay?lan? portb ye yükle
	MOVLW	0X01		    ; degilse portb ye 0x01 yukle
	MOVWF	PORTB		    
