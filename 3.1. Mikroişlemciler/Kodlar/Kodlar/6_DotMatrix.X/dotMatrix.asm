...
; ?c ?ce yaklas?k 1sn gecikme olur. 
; NOP bir cycle bekleme yapaca?? unutulmamal?
	
; DOT matrix uygulamas?
...
BASLA
	...
	BANKSEL	TRISB		    ; portb nin VE PORTC N?N hepsini ç?k?? yap
	CLRF	TRISB
	CLRF	TRISC
	...
	CLRF	PORTC
DD
	MOVLW	b'01111111'	    ;7 sat?r da yans?n  hepsi yans?n 
	MOVWF	PORTB
	MOVLW	b'00011111'	    ;Sutunlar yans?n
	MOVWF	PORTC
	GOTO	DD
